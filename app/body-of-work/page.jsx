    ...
    <>
      ...
      <main id="main">
          ...
          <div className="narrow">
            ...
            <div className="split-grid" id="radical-next" style={{ alignItems: 'start' }}>
              ...
              <div>
                ...
                <a href="https://www.amazon.com/Radical-Next-Reclaiming-Humanity-Post-Human/dp/B0DGV4265T" className="btn btn-ink" target="_blank" rel="noopener noreferrer">Buy on Amazon<span className="ext" aria-hidden="true" /></a>
              </div>
            </div>
            ...
            <div className="split-grid flip" id="bitcoin-pizza" style={{ alignItems: 'start', marginTop: 96 }}>
              ...
              <div>
                ...
                <a href="https://www.amazon.com/Bitcoin-Pizza-No-Bullshit-Guide-Blockchain/dp/1544504438" className="btn btn-ink" target="_blank" rel="noopener noreferrer">Buy on Amazon<span className="ext" aria-hidden="true" /></a>
              </div>
            </div>
          </div>
        </section>
        ...
        <CtaBreak
          ...
          external
          btn="Visit Illicit Shadows" btnExternal
        ...
        <section className="gallery">
          ...
          <div className="more">
            <a href={SITE.social.youtube} className="btn btn-ghost" target="_blank" rel="noopener noreferrer">All videos on YouTube<span className="ext" aria-hidden="true" /></a>
          </div>
        </section>
