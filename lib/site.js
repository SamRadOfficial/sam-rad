...
export const personSchema = {
  ...
  // One job title across the whole site and both Person blocks. Search engines and AI
  // tools treat a person described three ways as three weaker entities. 22 Sep 2026.
  jobTitle: 'The Change Futurist',
  description:
