export const SITE = {
  ...
  defaultOg: '/images/hero-work.jpg',
  defaultOgAlt: 'Sam Rad, the change futurist, delivering a keynote on stage',
  bureau: {
    agent: 'Brandy Gibson',
...
export function meta({ title, description, path = '/', image, imageAlt, article }) {
  ...
  return {
    ...
    openGraph: {
      ...
      locale: 'en_US',
      images: [{ url: src, alt, type: 'image/jpeg' }],
      ...(article ? {
